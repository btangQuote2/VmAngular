...
export const ScriptStore: Scripts[] = [
  { name: 'jqLibJS', src: '../../assets/js/jquery.js' },
  // Login
  ...
  {
    name: 'vendorMomentTZJS',
    src: '../../assets/js/vendor/moment-timezone-with-data-2012-2022.min.js'
  },
  { name: 'vendorCalJS', src: '../../assets/js/vendor/clndr.min.js' },
  {
    name: 'vendorJqueryTouchJS',
    src: '../../assets/js/vendor/jquery.touchSwipe.min.js'
  },
  ...
  {
    name: 'vendorRangesliderJS',
    src: '../../assets/js/vendor/rangeslider.min.js'
  },
  {
    name: 'vendorJqueryDatatablesJS',
    src: '../../assets/js/vendor/jquery.dataTables.min.js'
  },
  {
    name: 'vendorDatatablesFixedColJS',
    src: '../../assets/js/vendor/dataTables.fixedColumns.min.js'
  },
  {
    name: 'vendorDatatablesColReorderJS',
    src: '../../assets/js/vendor/dataTables.colReorder.js'
  },
  ...
  {
    name: 'vendorPerfScrollbarJS',
    src: '../../assets/js/vendor/perfect-scrollbar.jquery.js'
  },
