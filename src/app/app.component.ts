      ...
      router.events.subscribe((val) => {
        if ( location.path() !== '') {
          this.route = location.path();
            ...
            } else if (this.route === '/roleselect'
            || this.route === '/register' || this.route === '/loginuser' || this.route === '/invalidinput'
             || this.route === '/forgotusrname' || this.route === '/forgotusrnmresp' || this.route === '/forgotpw'
              || this.route === '/forgotpwresp' || this.route === '/secquestions' || this.route === '/initlogin') {
